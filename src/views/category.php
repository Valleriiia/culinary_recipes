...
<body>
    ...
    <form method="GET" action="/category.php">
        ...
        <a href="/dashboard/recipes/public/category.php?id=<?= htmlspecialchars($category['id']); ?>" style="margin-left: 10px;">Скинути фільтри</a>
    </form>
    ...
    <ul>
        <?php foreach ($recipes as $recipe): ?>
            <li>
                <a href="/recipe.php?id=<?= $recipe['id']; ?>"><?= htmlspecialchars($recipe['name']); ?></a>
            </li>
        <?php endforeach; ?>
    </ul>
